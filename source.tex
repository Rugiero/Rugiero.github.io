...
Among many other things, this is interesting, because the small coherence time allows us to study the fading during a transmission while the satellite can be approximated to stay still. The following figures illustrate the RX baseband signal changing in time while the satellite moves. As expected, the variance in the signal strength is larger in the Rayleigh faded case.
