...
Mobile telephone signal propagation in a city is characterized essentially by obstacles which reflects the signal. In a city, the aggregate received signal follows approximately \htmladdnormallink{Rayleigh}{\ray} statistics if there is no line-of-sight path present between the transmitter and the receiver. 
