...
%%         \item Ilari Angervuori, Wichman Risto, Niloofar Okati, Taneli Riihonen, ``On routing protocols in inter-satellite communications,'' Proceedings of XXXV Finnish URSI Convention on Radio Science, 2019
        ...
        \end{figure}
                ...
                \item{While feasible, for simplicity, we do not model fast \htmladdnormallink{fading}{https://en.wikipedia.org/wiki/Fading}, shadowing, or other attenuation. For the narrow beam, the Doppler shifts are approximately identical for all interferers.
                 }
                 \end{enumerate}
