...
\subsection{January – Inverse of a Gaussian Variable Approaches a Gaussian Variable}

If $Y = p/X,$ where $X \sim N(\mu, \sigma)$, then $Y \sim N(p/\mu, \sigma p/\mu^2 )$, when $ p \rightarrow \infty.$

\begin{align*}
& \left| e^{-0.5(x - p/\mu)^2} - \frac{e^{-0.5(1/x-\mu)^2}}{x^2}\right|
\end{align*}
