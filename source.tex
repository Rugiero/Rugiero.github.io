...
# === Parameters ===
T_total = 30.0       # simulate P(t), I(t) on [0, 30] s
T_obs = 20.0         # we only "observe" up to 20 s
...
# === 4. 400-sample moving average on sampled powers (0..T_obs) ===
window_size = 400
...
# === 5. GPR prediction of P(t) on [0, 30] from noisy power samples on [0, 20] ===
...
# 400-sample MA on [0, T_obs]
ax1.plot(t_ma, power_ma, 'r-', label='MA of |I|² (0–20 s)')
...
ax1.set_title('Fig 1(a): True P(t), GPR estimate & forecast, and 400-sample MA & forecast', fontsize=12)
ax1.grid(True)
ax1.legend(fontsize=12)

# ---------- Subplot (b): I(t) and samples ----------
ax2.plot(t, I, label='I(t) = X(t)√P(t)', color='tab:orange')
ax2.plot(t_sampled, I_sampled, 'ko', label='Samples of I(t) (0–20 s, 0.1 kHz)', markersize=1)
