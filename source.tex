...
%%                    Furthermore, it can be shown that, under fairly general settings, the LEO BS receives a waveform $I(t)=\sqrt{P(t)}X(t)$, where $X(t)$ is a near-Gaussian noise waveform. This means that $I(t)$ can be approximated by a non-stationary Gaussian process with the varying variance $P(t)$. We will sample $|I(t)|^2$ to estimate the interference power $P(t)$.
