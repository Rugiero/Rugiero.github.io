        ...
        \end{itemize}        
                 ...
                 \item[7.]{The autocovariance of $P(t)$ at lag $\tau$ has the \htmladdnormallink{Gaussian form}{https://en.wikipedia.org/wiki/Radial_basis_function_kernel}
                   \begin{align*}
                     ...
                     &= \underbrace{\frac{p_t^2}{2\log(2)}  \pi \lambda\left(\frac{h \varphi_{\text{RX}}}{\sin^2(\epsilon)}\right)^2}_{ k\triangleq} \exp\left\{-\underbrace{v_{\text{sat}}^2\sin^4(\epsilon)\tau^2/(h^2 \varphi_{\text{RX}}^2)}_{D\triangleq } \log(2)/2\right\}, \tag{2}
                     \end{align*}
