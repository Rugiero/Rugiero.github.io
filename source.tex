...
I. Angervuori, M. Haenggi and R. Wichman, ``Meta Distribution of the SIR in a Narrow-Beam LEO Uplink,'' in IEEE Transactions on Communications, 2025, doi: 10.1109/TCOMM.2025.3547734.
        ...
        \end{itemize}        
                 ...
                 \begin{quotation}
                   \textit{A comprehensive, tractable, and solid SG system model provides hypothesis classes that guide us in the right direction in inferring the empirical ML signal data.}
                 \end{quotation}
