...
\begin{figure}
  ...
  \caption{Interference power field developing in time. Transmitters in Poisson distributed random locations are moving to random directions in time, and the aggregate signal strength after the fading is plotted – red color representing the highest mean power of interference and deep blue representing absence of any interference. There is a line-of-sight component is present – that is, we assume  \htmladdnormallink{Rician fading}{\ric}. Red occurrences will cause remarkable disturbance in communication as interference from other transmitters gets large. Time can't be considered to be in a human perspective scale here.}
\end{figure}
