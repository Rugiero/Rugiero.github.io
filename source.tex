...
\def\keeler{https://hpaulkeeler.com/poisson-point-process-simulation/}
\makeindex
...
\begin{center}
  ...
  \htmladdnormallink{H. Paul Keeler's Blog}{\keeler}
\end{center}
...
\bibitem{3}\htmladdnormallink{H. Paul Keeler's Blog}{\keeler}
