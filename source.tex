...
Why is this interesting? Well, because the movement of the satellites can't be omitted when modeling the satellite networks. However, the small coherence time allows us to study the fading while the satellite can be approximated to stay still. The following figures illustrate the RX baseband signal changing in time while the satellite moves. As expected, the variance in the signal strength is larger in the Rayleigh faded case.
