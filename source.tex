...
%%         \item Ilari Angervuori, Wichman Risto, Niloofar Okati, Taneli Riihonen, ``On routing protocols in inter-satellite communications,'' Proceedings of XXXV Finnish URSI Convention on Radio Science, 2019
        ...
        \end{figure}
                 ...
                 \item{While feasible, for simplicity, we do not model fast \htmladdnormallink{fading}{https://en.wikipedia.org/wiki/Fading}, shadowing, or other attenuation. For the narrow beam, the Doppler shifts are almost identical for all transmitters.
                 }
                 \end{enumerate}
                 ...
                 \item[7.]{The autocovariance of $P(t)$ at lag $\tau$ has the \htmladdnormallink{Gaussian form}{https://en.wikipedia.org/wiki/Radial_basis_function_kernel}
                   ...
                   For our satellite settings 2-3, theoretically, $k\approx 0.5$ and $D\approx 1.7555$. }
                 \end{enumerate}
