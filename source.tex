...
The following GNU Octave code produces plots of analog Gaussian and  $\alpha$-stable noises. The function \htmladdnormallink{digitaltoanalog}{https://ilari.angervuori.fi/node24.html} is given my the May's blog entry. Also, remember to import to statistical package to Octave.
