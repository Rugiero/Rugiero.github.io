...
%%         \item Ilari Angervuori, Wichman Risto, Niloofar Okati, Taneli Riihonen, ``On routing protocols in inter-satellite communications,'' Proceedings of XXXV Finnish URSI Convention on Radio Science, 2019
        ...
        \end{itemize}        
                 ...
                 \end{enumerate}
                 As the satellite moves, the magnitude of the aggregate interference varies due to the randomly distributed interferers. The key insight acquired from the SG analysis is as follows. (The details can be found in \htmladdnormallink{my thesis}{dissertation.pdf}, Sections 3.3 and 3.4.)
                 ...
                 \item[6.]{The normalized interference power (\textit{i.e.}, variance of $I$) is approximately \htmladdnormallink{gamma distributed}{https://en.wikipedia.org/wiki/Gamma_distribution} with the mean $\mathbb{E}(P)=1$ and the variance $\text{var}(P)=1/2$ (see \htmladdnormallink{thesis}{dissertation.pdf}, Theorems 3.3.6 and 3.3.7).}
...
\item[[2]] \htmladdnormallink{Angervuori, Ilari., Narrow-Beam Low Earth Orbit Communications and Stochastic Geometry: Non-Temporal and Temporal Interference Analysis, Thesis Draft; Aalto University}{dissertation.pdf}
\item[[3]] \htmladdnormallink{Oksanen, Maiju., Stokastinen geometria langattoman
