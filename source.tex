...
In the following figure, I have plotted the Fourier transform of my track \htmladdnormallink{Tappimarssi}{https://soundcloud.com/ilari-angervuori/tappimarssi}. The track was imported to Octave by

\begin{verbatim}
[signal, fs] = audioread('Tappimarssi.wav');
sampletimes = 0 : 1/fs : 1/fs*(length(y) - 1);
\end{verbatim}
