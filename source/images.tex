...
$\displaystyle = \underbrace{\frac{p_t^2}{2\log(2)}  \pi \lambda\left(\frac{h \varphi_{\text{RX}}}{\sin^2(\epsilon)}\right)^2}_{ k\triangleq} \exp\left\{-\underbrace{v_{\text{sat}}^2\sin^4(\epsilon)\tau^2/(h^2 \varphi_{\text{RX}}^2)}_{D\triangleq } \log(2)/2\right\},$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
