...
$\displaystyle = \frac{1}{2} \underbrace{\frac{\pi \lambda p_t^2}{\log(2)}  \left(\frac{h \varphi_{\text{RX}}}{\sin^2(\epsilon)}\right)^2}_{ k\triangleq} \left( E(H)^2\exp\left\{-\tau^2\underbrace{\frac{v_{\text{sat}}^2\sin^4(\epsilon)}{2 h^2 \varphi_{\text{RX}}^2}}_{D\triangleq } \log(2)\right\}  + K_H(\tau) \right)$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay2052}%
$\displaystyle =\frac{k}{2} \left(E(H)^2\exp\left\{-D\tau^2 \log(2)/2\right\} +   \text{var}(H) \text{triang}(\tau/\tau_c) \right),$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle \mathbb{E}(P)=\mathbb{E}(I^2)=$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay2095}%
$\displaystyle (I)= k \mathbb{E}(H)$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay2097}%
$\displaystyle (P)=k\mathbb{E}(H^2)/2.$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlpictureA{tex2html_wrap2106}%
